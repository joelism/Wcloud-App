...
function setupStartScreen(){
  ...
  if (btnEntries){
    btnEntries.addEventListener("click", ()=> goTo("capture"));
  }
  if (btnWheel){
    btnWheel.addEventListener("click", ()=> goTo("wheel"));
  }
  if (btnSettings){
...
async function renderAnalysis(){
  ...
  renderBars("#genderBars", groupBy(all, s=>s.gender || "—"), ["Männlich","Weiblich","Divers / Unklar","—"]);
