...
function spinNameWheel(){
  ...
  if (current) {
    ...
    // Große, präsente Darstellung des gezogenen Namens – mit !important, damit iOS-CSS nichts überschreibt
    current.style.setProperty("font-size", "2rem", "important");
    current.style.setProperty("font-weight", "900", "important");
    current.style.setProperty("text-align", "center", "important");
    current.style.setProperty("margin-top", "1.2rem", "important");
    current.style.setProperty("color", "#ffffff", "important");
    current.style.setProperty("letter-spacing", "0.6px", "important");
    current.style.setProperty("line-height", "1.2", "important");
    current.style.setProperty("opacity", "1", "important");
    current.style.setProperty("transition", "transform 0.25s ease, opacity 0.25s ease", "important");
    current.style.setProperty("transform", "scale(1.2)", "important");
    setTimeout(() => {
      current.style.setProperty("transform", "scale(1)", "important");
    }, 250);
  }
