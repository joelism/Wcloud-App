...
// - Einträge in IndexedDB (alter Name "PrivateTrackerDB" beibehalten -> alte Daten bleiben)
// - Bild-Pool per Bild-URL im localStorage
// - Startscreen im Wcloud-Design
// - Wheel-Bilder 4:3 + Vollbild-Lightbox mit Weiterklicken / Wischen

// -------- Service Worker sicher deaktivieren --------
...
// -------- IndexedDB für Einträge (alter DB-Name) --------
const DB_NAME = "PrivateTrackerDB";
const DB_VERSION = 2;
...
// -------- Bild-Pool (Bild-URLs im localStorage) + Lightbox --------
...
// -------- Lightbox (Vollbild + Klicken/Wischen) --------
...
function setupLightbox() {
  ...
  if (lb) {
    lb.addEventListener("click", ev => {
      if (ev.target === lb) closeLightbox(); // Klick auf dunklen Hintergrund
    });
  }

  // Einfaches Wischen (Touch)
  if (inner) {
    let startX = 0;
...
// -------- Einstellungen: Einträge löschen --------
